    ...
    <div className='fixed bottom-4 right-4 z-50'>
      ...
      <div
        className={`fixed inset-0 z-50 flex items-center justify-center p-4 transition-all duration-300 ease-in-out ${
          isOpen
            ? 'opacity-100 backdrop-blur-sm bg-black bg-opacity-50 shadow-xl'
            : 'opacity-0 pointer-events-none'
        }`}
      >
        <div className='relative w-80 md:w-96 lg:w-[30rem] bg-white rounded-lg shadow-lg border border-gray-200 p-4'>
          <button
            onClick={handleClose}
          ...
          <p>
            If you have any{' '}
            <span className='font-bold'>questions and need help</span>, feel
            free to chat with us on WhatsApp below!
          </p>
          <a
