...
const WhatsAppButton = () => {
  ...
  return (
    <div className='fixed bottom-4 right-4 '>
      ...
      >
        <p>
          Jika anda ada beberapa pertanyaaan, silahkan hubungi kami melalui
          WhatsApp kami dengan menekan tombol ini!
        </p>
        <a
...
'
          ...
          className='mt-4 flex items-center justify-center px-4 py-2 bg-black text-white rounded-full shadow-md hover:bg-gray-800 transition duration-300'
        >
          <svg
            xmlns='http://www.w3.org/2000/svg'
            viewBox='0 0 24 24'
